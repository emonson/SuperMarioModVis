...
var DISTRICT = (function(d3){
	...
	var ptime_width = 800;
	var ptime_block_height = 20;
	// 238 patches
	var ptime_height = (238+2)*ptime_block_height;
	...
	dis.update_path_time = function(mods_list) {
		...
		ptimebar.enter()
			...
			.attr("y", function(d){ return d.i * ptime_block_height; })
			.attr("width", function(d){ return ptime_scale(d.bytes); })
			.attr("height", ptime_block_height);
	...
	dis.visgen = function(district_id) {
		...
		d3.json('patches_all.json', function(error_path, mods_list) {
